...
Before executing the installer, ensure that you have an active AUR helper installed. This script natively uses `yay` to handle both official repository packages and AUR packages.
